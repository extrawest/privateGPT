...
Then, download the LLM model and place it in a directory  "models/" :
- LLM: for example: mistral-7b-openorca.Q4_0.gguf  [GPT4All] (https://gpt4all.io/index.html)
...
# CPU
Using an older CPU without  AVX2 support could potentially lead to problems 

# Related
The project was created through inspiration and adaptation of this project [privateGPT](https://github.com/imartinez/privateGPT).